...
import code from './components/assets/image/homepage/code.jpg'
        ...
        <React.Fragment>
            <EventsStyled>
                ...
                <div className="norm-events">
                    <div style={{ paddingBottom: "1em", height: "30em", overflow: "hidden", position: "relative" }}>
                        <div className="">
                            <img src={code} style={{ objectFit: "contain", width: "100%" }} />
                        </div>
                        <div className="" style={{ position: "absolute", display: "flex", flexDirection: "column", textAlign: "center", flexWrap: "wrap", justifyContent: "center", alignContent: "center", color: "white", top: "0", bottom: "0", left: "0", right: "0", background: "rgba(0,0,0, 0.75)" }}>
                            <div className="title">
                                Events
                        </div>
                            <div style={{ fontSize: "2.4em" }}>Hackatons, competitions and all</div>
                        </div>
                    </div>
                </div>
